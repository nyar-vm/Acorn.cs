...
namespace Acorn.Psd.Tests;

public class PsdScannerTests
{
    private static byte[] BuildMinimalPsd(int width = 100, int height = 100, ushort channels = 3, ushort depth = 8, ushort colorMode = 3)
    {
    ...
    {
        var bytes = BuildMinimalPsd(200, 150, 3, 8, 3);
    ...
    {
        var bytes = BuildMinimalPsd(100, 100, 3, 8, (ushort)PsdColorMode.Rgb);
        var scanner = new PsdScanner(bytes);
    ...
    {
        var bytes = BuildMinimalPsd(100, 100, 4, 8, (ushort)PsdColorMode.Cmyk);
        var scanner = new PsdScanner(bytes);
    ...
    {
        var bytes = BuildMinimalPsd(100, 100, 1, 8, (ushort)PsdColorMode.Grayscale);
        var scanner = new PsdScanner(bytes);
