    ...
    public void Scanner_ScanStatistics_CountsGraphElements()
    {
        var data = new OnnxModelData
        {
            ...
            Graph = new OnnxGraph
            {
                ...
                Initialization =
                [
                    new OnnxTensor { Name = "w", DataType = OnnxDataType.Float, Dims = [10, 10], RawData = new byte[400] },
        ...
        var bytes = OnnxEncoder.Encode(data);
        var scanner = new Acorn.Onnx.Scanner.OnnxScanner(bytes);
    ...
    public void EncodeDecode_FullModel_Roundtrip()
    {
        var data = new OnnxModelData
        {
            ...
            Graph = new OnnxGraph
            {
                ...
                Initialization =
                [
                    new OnnxTensor { Name = "const", DataType = OnnxDataType.Float, Dims = [1], RawData = [0, 0, 0, 0] }
                ]
            }
        };
