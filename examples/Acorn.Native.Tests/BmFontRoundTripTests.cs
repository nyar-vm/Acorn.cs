...
using Acorn.BmFont.Decode;
using Acorn.BmFont.Encode;
using Acorn.BmFont.Scanner;
    ...
    public void EncodeDecode_CharChannels_Roundtrip()
    {
        var original = new BmFontData
        {
            ...
            Chars = new List<BmFontChar>
            {
                ...
                new() { Id = 33, X = 5, Y = 0, Width = 8, Height = 12, XAdvance = 10, Channel = BmFontChannel.GlyphAndOutline },
