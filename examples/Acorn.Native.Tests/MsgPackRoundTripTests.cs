...
using Acorn.MessagePack.Decode;
using Acorn.MessagePack.Encode;
using Acorn.MessagePack.Scanner;
...
public sealed class MsgPackRoundTripTests
{
    ...
    {
        var data = new MsgPackData { Root = new MsgPackValue { Type = MsgPackType.UnsignedInteger, RawValue = 0xFFFFFFFFUL } };
        var encoder = new MsgPackEncoder();
        var bytes = encoder.Encode(data);
    ...
    {
        var data = new MsgPackData { Root = new MsgPackValue { Type = MsgPackType.Float, RawValue = 3.141592653589793 } };
        var encoder = new MsgPackEncoder();
        var bytes = encoder.Encode(data);
    ...
    public void Scan_MixedTypes_AccumulatesAll()
    {
        ...
        var bytes2 = encoder.Encode(new MsgPackData { Root = new MsgPackValue { Type = MsgPackType.Integer, RawValue = 1L } });
        var bytes3 = encoder.Encode(new MsgPackData { Root = new MsgPackValue { Type = MsgPackType.String, RawValue = "hi" } });
