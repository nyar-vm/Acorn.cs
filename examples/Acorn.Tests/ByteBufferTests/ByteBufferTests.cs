...
namespace Acorn.Tests.ByteBufferTests;
...
public class ByteBufferMagicTests
{
    ...
    public void MatchMagic_ReturnsTrueWhenMatching()
    {
        ...
        Assert.True(buffer.MatchMagic(new byte[] { 0x89, 0x50 }));
    }
    ...
    public void MatchMagic_ReturnsFalseWhenNotMatching()
    {
        ...
        Assert.False(buffer.MatchMagic(new byte[] { 0xFF, 0x50 }));
    }

    [Fact]
    public void MatchMagic_ReturnsTrueForEmptyMagic()
    {
        var buffer = new ByteBuffer(new byte[] { 1, 2, 3 });
    ...
    {
        var buffer = new ByteBuffer(new byte[] { 0x89 });
        Assert.False(buffer.MatchMagic(new byte[] { 0x89, 0x50 }));
    }
    ...
    public void ConsumeMagic_AdvancesPositionOnMatch()
    {
        ...
        Assert.True(buffer.ConsumeMagic(new byte[] { 0x89, 0x50 }));
        Assert.Equal(2, buffer.Position);
    }
    ...
    public void ConsumeMagic_DoesNotAdvanceOnMismatch()
    {
        ...
        Assert.False(buffer.ConsumeMagic(new byte[] { 0xFF, 0x50 }));
        Assert.Equal(0, buffer.Position);
    }
}
...
{
    private readonly byte[] _leData = [0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08];
    private readonly byte[] _beData = [0x08, 0x07, 0x06, 0x05, 0x04, 0x03, 0x02, 0x01];

    [Fact]
    public void ReadU8_ReturnsCorrectValue()
    {
        var buffer = new ByteBuffer(new byte[] { 0x42 });
    ...
    {
        var buffer = new ByteBuffer(_leData);
    ...
    {
        var buffer = new ByteBuffer(_beData);
    ...
    {
        var buffer = new ByteBuffer(new byte[] { 0xFF });
    ...
    {
        var buffer = new ByteBuffer(new byte[] { 0x00, 0x80 });
    ...
    {
        var buffer = new ByteBuffer(new byte[] { 0x00, 0x00, 0x00, 0x80 });
    ...
    {
        var buffer = new ByteBuffer(new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80 });
    ...
    {
        var buffer = new ByteBuffer(new byte[] { 0x80, 0x00 });
    ...
    {
        var buffer = new ByteBuffer(new byte[] { 0x80, 0x00, 0x00, 0x00 });
    ...
    {
        var buffer = new ByteBuffer(new byte[] { 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 });
...
public class ByteBufferLeb128ReadTests
{
    ...
    {
        var buffer = new ByteBuffer(new byte[] { 0x05 });
    ...
    {
        var buffer = new ByteBuffer(new byte[] { 0xE5, 0x8E, 0x26 });
    ...
    {
        var buffer = new ByteBuffer(new byte[] { 0x7F });
    ...
    {
        var buffer = new ByteBuffer(new byte[] { 0x00 });
    ...
    {
        var buffer = new ByteBuffer(new byte[] { 0x01 });
    ...
    {
        var buffer = new ByteBuffer(new byte[] { 0x02 });
        Assert.Equal(1, buffer.ReadZigZagLeb128I32());
    }
    ...
    {
        var buffer = new ByteBuffer(new byte[] { 0x80 });
        var threw = false;
        try { buffer.ReadLeb128U32(); }
        catch (InvalidOperationException) { threw = true; }
        Assert.True(threw);
    }
    ...
    {
        var buffer = new ByteBuffer(new byte[] { 0x80, 0x80, 0x80, 0x80, 0x80 });
        var threw = false;
        try { buffer.ReadLeb128U32(); }
