...
public enum WasmOpcode : ushort
{
    ...
    #region SIMD 指令（前缀 0xFD，操作码值遵循 W3C WebAssembly SIMD 规范最终版本）
    ...
    #region 异常处理指令（Exception Handling 提案）

    /// <summary>抛出异常，参数在栈上。</summary>
    Throw = 0x08,

    /// <summary>重新抛出栈顶的异常引用。</summary>
    ThrowRef = 0x0A,

    /// <summary>try_table 块，替代传统 try/catch 结构。</summary>
    TryTable = 0x1F,
